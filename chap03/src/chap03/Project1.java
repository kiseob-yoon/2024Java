...
//	}
	...
	public static void register(Scanner scanner,String memberName,String memberSSN,String memberTel) {
	...
	public static void main(String[] args) {
		...
		String memberSSN = ""; // 회원 생년월일(패스워드 사용)
			...
			case 2:
				...
				do {
					...
					if(answer.equals("n") || answer.equals("N")) {
						continue AAA;//AAA키워드를 선언한 반복문으로 돌아감
				...
				register(scanner,memberName,memberSSN,memberTel);
